...
#Freqs
f1=np.array([1200,1800])
f2=np.array([2200, 2800])
# Encoder
BYTE_ENDIANESS = "big"
BYTE_BIT_SIZE = 8
...
TIME_PER_CHUNK = 0.005  # MODIFIABLE
TOTAL_ELEM_NUMBER = NEEDED_AMOUNT_OF_VECTORS * TIME_PER_CHUNK
ELEMENTS_PER_CHUNK = int(TIME_PER_CHUNK * SAMPLES_PER_SEC )
RECORDING_TIME_IN_ADDITION = 2  # MODIFIABLE
NOISE_TIME = 2  # MODIFIABLE
RECORDING_TIME_TOTAL = NEEDED_AMOUNT_OF_VECTORS * TIME_PER_CHUNK + NOISE_TIME + RECORDING_TIME_IN_ADDITION
#RECORDING_TIME_TOTAL = 40 * TIME_PER_CHUNK + NOISE_TIME + RECORDING_TIME_IN_ADDITION
RECORDING_SAMPLES_TOTAL = RECORDING_TIME_TOTAL * SAMPLES_PER_SEC
NUMBER_DATA_SAMPLES = ELEMENTS_PER_CHUNK / CHUNK_SIZE * CODE_WORD_LENGTH * BYTE_BIT_SIZE#int(SAMPLES_PER_SEC * TOTAL_ELEM_NUMBER)
