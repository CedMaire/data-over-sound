...
NEEDED_AMOUNT_OF_CHUNKS = (CODE_WORD_LENGTH * int(BYTE_BIT_SIZE / CHUNK_SIZE))
...
# Samples and Time
SAMPLES_PER_SEC = 44100  # MODIFIABLE
TIME_PER_CHUNK = 0.05  # MODIFIABLE
TOTAL_DATA_TIME = NEEDED_AMOUNT_OF_CHUNKS * TIME_PER_CHUNK
SAMPLES_PER_CHUNK = int(TIME_PER_CHUNK * SAMPLES_PER_SEC)
RECORDING_TIME_ADDED = 6  # MODIFIABLE
NOISE_TIME = 2  # MODIFIABLE
RECORDING_TIME_TOTAL = TOTAL_DATA_TIME + NOISE_TIME + RECORDING_TIME_ADDED
RECORDING_SAMPLES_TOTAL = int(RECORDING_TIME_TOTAL * SAMPLES_PER_SEC)
NUMBER_DATA_SAMPLES = int(SAMPLES_PER_SEC * TOTAL_DATA_TIME)
