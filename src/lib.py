...
ELEMENTS_PER_CHUNK = TIME_PER_CHUNK * SAMPLES_PER_SEC
RECORDING_TIME_AMPLIFIER = 150  # MODIFIABLE
NOISE_TIME = 0.5  # MODIFIABLE
RECORDING_TIME_TOTAL = RECORDING_TIME_AMPLIFIER * TIME_PER_CHUNK + NOISE_TIME
RECORDING_SAMPLES_TOTAL = RECORDING_TIME_TOTAL * SAMPLES_PER_SEC
NUMBER_DATA_SAMPLES = TIME_PER_CHUNK * SAMPLES_PER_SEC * NEEDED_AMOUNT_OF_VECTORS
...
NOISE_DETECTION_TIME = 1  # MODIFIABLE
