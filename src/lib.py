...
RECORDING_TIME_IN_ADDITION = 20  # MODIFIABLE
NOISE_TIME = 2  # MODIFIABLE
RECORDING_TIME_TOTAL = NEEDED_AMOUNT_OF_VECTORS * \
    TIME_PER_CHUNK + NOISE_TIME + RECORDING_TIME_IN_ADDITION
...
NUMBER_DATA_SAMPLES = ELEMENTS_PER_CHUNK / \
    CHUNK_SIZE * CODE_WORD_LENGTH * BYTE_BIT_SIZE
