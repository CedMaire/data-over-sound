...
if __name__ == '__main__':
    ...
    noise = NoiseGenerator().generateBandLimitedNoise(
    ...
    WavFile.write(dirname + "noise_" + repr(Lib.UPPER_LOW_FREQUENCY_BOUND) + "-" +
                  repr(Lib.UPPER_UPPER_FREQUENCY_BOUND) + ".wav", Lib.SAMPLES_PER_SEC, noise)
